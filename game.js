...
BasicGame.Game.prototype = {
  preload: function () {
    ...
    this.load.spritesheet('greenEnemy', 'assets/enemy.png', 64, 64);
    this.load.spritesheet('whiteEnemy', 'assets/shooting-enemy.png', 64, 64);
    this.load.spritesheet('boss', 'assets/boss.png', 124, 86);
    this.load.spritesheet('explosion', 'assets/explosion.png', 32, 32);
    this.load.spritesheet('player', 'assets/player.png', 92, 87);
  ...
  setupEnemies: function () {
    ...
    this.bossPool.forEach(function (enemy) {
      enemy.animations.add('fly', [ 0, 1, 2, 1 ], 10, true);
      enemy.animations.add('hit', [ 3, 1, 3 ], 10, false);
      enemy.events.onAnimationComplete.add( function (e) {
        e.play('fly');
      }, this);
    });
  ...
  setupBullets: function () {
    ...
    this.enemyBulletPool.createMultiple(75, 'enemyBullet');
  ...
  setupPlayerIcons: function () {
    ...
    this.powerUpPool.forEach(function (powerup1) {
        powerup1.scale.setTo(0.5, 0.5);
    });
  ...
  setupText: function () {
    this.instructions = this.add.text(
      ...
      'Uzyj strzalek aby sie poruszac, Z to strzal',
  ...
  processDelayedEffects: function () {
    ...
    if (this.showReturn && this.time.now > this.showReturn) {
      this.returnText = this.add.text(
        ...
        'Wcisnij Z aby wrocic do menu gry',
